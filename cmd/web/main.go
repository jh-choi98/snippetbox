...
func main() {
	...
	// The value returned from the flag.String() function is a pointer to the flag value, not the value itself. So we need to dereference the pointer before using it.
