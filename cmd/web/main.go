...
func main() {
	...
	// Use log.New() to create a logger for writing information messages. This takes three parameters: the destination to write the logs to, a string prefix for message, and flags to indicate what additional information to include. Note that the flags are joined using the bitwise OR operator.
